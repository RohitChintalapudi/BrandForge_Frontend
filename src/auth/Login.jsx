...
const Login = () => {
  ...
  const { user, setUser } = useAuth(); // 👈 get user also

  // 🔒 EASY FIX:
  // If user is already logged in and somehow reaches /login (back button),
  // immediately redirect to their dashboard
  useEffect(() => {
    if (user) {
  ...
  return (
    <div className="auth-page auth-page-stable">
